...
load=loadmat('/media/HDD1/zyz/FROG_train_Poisson/XUV_IR_test_Poisson_johnathon_sample4_mixed_5-100_myA.mat')
I_test=load['I_test']
...
save_fig=False
loadname='CVAE_pulse_phase_mixed_Poisson_johnathon_sample4_no_MSEY_5-100'
n_instances=25
ind_plot_list=np.arange(0,600)
...
Et_recon_group=np.zeros((n_instances,np.size(ind_plot_list),2048),dtype='complex64')
Ef_recon_group=np.zeros((n_instances,np.size(ind_plot_list),232),dtype='complex64')
...
savemat('./RcVAE_results/'+loadname+'_statistics.mat',\
        {'MSE_trace':MSE_trace,
         ...
         'xuv_Ef_recon':Ef_recon_group,'xuv_Ef_test':xuv_Ef_test_cropped,
         'xuv_Et_recon':Et_recon_group,'xuv_Et_test':xuv_Et_test,
