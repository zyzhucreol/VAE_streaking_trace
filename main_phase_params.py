...
X_train,I_train,_,X_test,I_test,_=read_data(\
                                            '/media/HDD1/zyz/FROG_train_Poisson/XUV_IR_train_Poisson_hard_3counts_myA.mat',\
                                            '/media/HDD1/zyz/FROG_train_Poisson/XUV_IR_test_Poisson_hard_3counts_myA.mat')
...
args.train_iters=40000 # number of training iterations
...
args.N_eng=256
args.N_tau=38
args.counts=3 # Poission peak counts in experiment

# file I/O parameters
load_model=False
save_name='CVAE_pulse_phase_Poisson_3counts'
