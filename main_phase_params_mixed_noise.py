...
from Pulse_retrieval.layers_phase_params import recognition_encoder, encoderY, decoder#, LSTM_decoder
from tensorflow.contrib.rnn import BasicLSTMCell
from Pulse_retrieval.forward_model_phase import A_fun, xuv_taylor_to_E, ir_from_params
...
X_train,I_train,counts_train,X_test,I_test,counts_test=read_data(\
                                            '/media/HDD1/zyz/FROG_train_Poisson/XUV_IR_train_Poisson_hard_mixed_2-100_myA.mat',\
                                            '/media/HDD1/zyz/FROG_train_Poisson/XUV_IR_test_Poisson_hard_mixed_2-100_myA.mat')
...
args.T=3 # number of recurrences
args.d_channels=4
...
args.N_xuv=6 # number of XUV phase parameters
...
# file I/O parameters
load_model=False
save_name='CVAE_pulse_phase_mixed_Poisson_no_MSEY_2-100_3iter_Poisson_diff'
save_model_path='./models/'+save_name # path to save trained model
load_model_path='./models/'+'CVAE_pulse_phase_mixed_Poisson_no_MSEY_2-100_3iter_Poisson_diff' # path to load pre-trained weights, if load_model=True
...
L_hybrid=tf.add(Lx,0.005*KL_loss,'L')
...
for kk in range(n_instance):
    samples_test = sess.run(Xp,feed_dict={y:I_test,counts:counts_test})
